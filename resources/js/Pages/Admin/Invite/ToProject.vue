...
export default {
    ...
    watch: {
        form: {
            ...
            handler: debounce(function () {
                this.$inertia.get(this.route('admin.projects.invite', this.project.id), pickBy(this.form), {preserveState: true, only: ['users']})
            }, 500),
        }
    },
    data: function () {
    ...
    methods: {
        ...
        invite() {
            this.formInvite.post(this.route('admin.projects.invite-store', this.project.id), this.formInvite.pickedUsers);
        }
    }
}
</script>
